...
En este sentido, Duarte Sánchez y Guerrero Barreto (2024) destacan que el cuestionario constituye el núcleo de la encuesta, funcionando no solo como un conjunto de preguntas, sino como un instrumento meticuloso para medir una realidad específica, resaltando además su papel estratégico en la toma de decisiones organizacionales gracias a su capacidad de obtener y procesar datos de manera rápida y eficiente.
